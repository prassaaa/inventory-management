                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Today's Sales</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($todaySales, 0, ',', '.') }}</div>
                        </div>
                        <div class="col-auto">
...
<script>
    ...
    var topProductsChart = new Chart(ctx2, {
        type: 'doughnut',
        data: {
            labels: {!! json_encode($topProductsData['labels']) !!},
            datasets: [{
                data: {!! json_encode($topProductsData['data']) !!},
