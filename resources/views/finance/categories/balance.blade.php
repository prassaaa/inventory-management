...
@section('title', 'Manajemen Kategori Saldo')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-dark fw-bold">
                <i class="fas fa-tags me-2 text-primary"></i> Manajemen Kategori Saldo
            </h1>
            <p class="text-muted">Kelola kategori saldo yang dapat digunakan</p>
        </div>
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 fw-bold text-primary">Tambah Kategori Saldo Baru</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('finance.categories.balance.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="col-md-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 fw-bold text-primary">Daftar Kategori Saldo</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($category->type == 'liability')
                                                <span class="badge bg-danger">Liability</span>
                                            @else
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center">Belum ada kategori saldo</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
