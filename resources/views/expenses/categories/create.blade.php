...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-dark fw-bold">
                <i class="fas fa-tag me-2 text-primary"></i> Tambah Kategori Pengeluaran
            </h1>
            <p class="text-muted">Buat kategori baru untuk pencatatan pengeluaran keuangan</p>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 fw-bold text-primary">Form Kategori Baru</h6>
        </div>
        <div class="card-body">
